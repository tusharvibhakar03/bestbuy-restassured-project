...
public class StoresAssertionTest {
    ...
    // 1) Verify that the stores  of total is = 1561
    @Test
    public void test001() {response.body("total",equalTo(1561));


    }

  //2) verify stores of limit is equal to 10.
  ...
  //3) check the single 'Name' in the Arraylist(Inver Grove Heights)
    ...
    @Test
    public void test003(){response.body("data.name",hasItem("Inver Grove Heights"));}


    //4) Check the multiple ‘Names’ in the ArrayList (Roseville, Burnsville, Maplewood)
   @Test

   public void test004(){response.body("data.name", hasItems("Roseville","Burnsville","Maplewood"));}
